/*
  ...
  USAGE: java edu.asupoly.ser322.jdbcex.DriverVersion <query> <url> <user> <passwd> <classname> [<classname>|...]

  Example:
  % java edu.asupoly.ser322.jdbcex.DriverVersion "select * from test1" "jdbc:postgresql://localhost:5434/demo" demo ser322 org.postgresql.Driver com.mysql.jdbc.Driver oracle.jdbc.driver.OracleDriver net.sourceforge.jtds.jdbc.Driver
...
public class DriverVersion {
	public static void main(String[] args)
	{
		...
		if (args.length < 5)
		{
			System.out.println("USAGE: java edu.asupoly.ser322.jdbcex.DriverVersion <url> <user> <passwd> <query> <classname> [<classname>|...]");
			System.exit(0);
		}
		...
		try {
			...
			System.out.println("Executing query " + args[3] + " on URL " + args[1]);
			...
			if (driver != null) {
				...
				conn = driver.connect(args[0], props);
