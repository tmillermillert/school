...
public class AppFrame extends JFrame {
    ...
    JMenuItem jMenuFormatP = new JMenuItem(new BlockAction(editor.T_P,
            ""));
    JMenuItem jMenuFormatH1 = new JMenuItem(new BlockAction(editor.T_H1,
            ""));
    JMenuItem jMenuFormatH2 = new JMenuItem(new BlockAction(editor.T_H2,
            ""));
    JMenuItem jMenuFormatH3 = new JMenuItem(new BlockAction(editor.T_H3,
            ""));
    JMenuItem jMenuFormatH4 = new JMenuItem(new BlockAction(editor.T_H4,
            ""));
    JMenuItem jMenuFormatH5 = new JMenuItem(new BlockAction(editor.T_H5,
            ""));
    JMenuItem jMenuFormatH6 = new JMenuItem(new BlockAction(editor.T_H6,
            ""));
    JMenuItem jMenuFormatPRE = new JMenuItem(new BlockAction(
            editor.T_PRE, ""));
    JMenuItem jMenuFormatBLCQ = new JMenuItem(new BlockAction(
            editor.T_BLOCKQ, ""));
    JMenu jjMenuFormatChStyle = new JMenu();
    JMenuItem jMenuFormatChNorm = new JMenuItem(new InlineAction(
            editor.I_NORMAL, ""));
    JMenuItem jMenuFormatChEM = new JMenuItem(new InlineAction(
            editor.I_EM, ""));
    JMenuItem jMenuFormatChSTRONG = new JMenuItem(new InlineAction(
            editor.I_STRONG, ""));
    JMenuItem jMenuFormatChCODE = new JMenuItem(new InlineAction(
            editor.I_CODE, ""));
    JMenuItem jMenuFormatChCite = new JMenuItem(new InlineAction(
            editor.I_CITE, ""));
    JMenuItem jMenuFormatChSUP = new JMenuItem(new InlineAction(
            editor.I_SUPERSCRIPT, ""));
    JMenuItem jMenuFormatChSUB = new JMenuItem(new InlineAction(
            editor.I_SUBSCRIPT, ""));
    JMenuItem jMenuFormatChCustom = new JMenuItem(new InlineAction(
            editor.I_CUSTOM, ""));
    ...
    private void jbInit() throws Exception {
        this.setIconImage(new ImageIcon(AppFrame.class.getResource(
                "/ui/icons/bus_frame_icon.png"))
                .getImage());
        contentPane = (JPanel) this.getContentPane();
        contentPane.setLayout(borderLayout1);
        //this.setSize(new Dimension(800, 500));
        this.setTitle("Bus Scheduler - " + CurrentProject.get().getTitle());
        ...
        jMenuHelpGuide.setIcon(new ImageIcon(AppFrame.class.getResource(
                "/ui/icons/help.png")));
//        jMenuHelpGuide.setEnabled(false);
        ...
        jMenuHelpWeb.setText(Local.getString("Bus Scheduler Web Site"));
        jMenuHelpWeb.setIcon(new ImageIcon(AppFrame.class.getResource(
                "/ui/icons/web.png")));
//        jMenuHelpWeb.setEnabled(false);
        ...
        jMenuHelpAbout.setText(Local.getString("About Bus Scheduler"));
        ...
        CurrentProject.addProjectListener(new ProjectListener() {
            ...
            public void projectWasChanged() {
                setTitle("Bus Scheduler - " + CurrentProject.get().getTitle());
            }
        });

    }

    protected void jMenuHelpBug_actionPerformed(ActionEvent e) throws MalformedURLException {
        url = new URL(App.BUGS_TRACKER_URL);
        Util.openBrowser(url);
    }
   
    protected void jMenuHelpWeb_actionPerformed(ActionEvent e) throws MalformedURLException {
        url = new URL(App.WEBSITE_URL);
        Util.openBrowser(url);
    }
   
    protected void jMenuHelpGuide_actionPerformed(ActionEvent e) throws MalformedURLException {
        url = new URL(App.GUIDE_URL);
        Util.openBrowser(url);
...
//        exitNotify();
//        App.closeWindow();
        App.frame.setState(Frame.ICONIFIED);
    }
