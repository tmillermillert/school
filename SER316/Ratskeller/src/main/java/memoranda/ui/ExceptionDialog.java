...
public class ExceptionDialog extends JDialog {
  ...
  private void jbInit() throws Exception {    
    ...
    "Click on <b>Report bug..</b> button to submit a bug to the Bus Scheduler bugs tracker on GitHub.com </html>");
  ...
  void reportB_actionPerformed(ActionEvent e) throws MalformedURLException {
