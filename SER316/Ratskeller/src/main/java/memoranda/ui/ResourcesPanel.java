    ...
    void removeResB_actionPerformed(ActionEvent e) {
        ...
        int n =
            JOptionPane.showConfirmDialog(
                App.getFrame(),
                msg,
                Local.getString("Remove the resource"),//change 3
        ...
        public void mouseClicked(MouseEvent e) {
            if ((e.getClickCount() == 2) && (resourcesTable.getSelectedRow() > -1)) {
                ...
                if (path.length() >0)
                    ...
                    runBrowser((URI) resourcesTable.getValueAt(resourcesTable.getSelectedRow(), 0));
            }
