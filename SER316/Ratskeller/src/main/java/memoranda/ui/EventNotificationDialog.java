...
public class EventNotificationDialog extends JFrame {
  ...
  JLabel busDestinationLabel = new JLabel();
  //JLabel busNumberLabel = new JLabel();
  JLabel timeLabel = new JLabel();
  Border border4;

  public EventNotificationDialog(String title, String time, String busDestination) {
    super();
    this.setTitle(title);
    try {
      jbInit();
    ...
    busDestinationLabel.setText(busDestination);
  ...
  void jbInit() throws Exception {
    ...
    this.setIconImage(new ImageIcon(EventNotificationDialog.class.getResource("/ui/icons/bus_frame_icon.png")).getImage());
    ...
    busDestinationLabel.setHorizontalAlignment(SwingConstants.CENTER);
    //busNumberLabel.setHorizontalAlignment(SwingConstants.CENTER);
    getContentPane().add(panel1);
    panel1.add(jPanel1,  BorderLayout.SOUTH);
    jPanel1.add(jButton1, null);

    jPanel1.setBackground(new Color(251, 197, 63));
    panel1.add(busDestinationLabel, BorderLayout.CENTER);
    //panel1.add(busNumberLabel, BorderLayout.CENTER);
