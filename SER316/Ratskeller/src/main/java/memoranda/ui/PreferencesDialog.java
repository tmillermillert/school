...
//TODO Look and feel buttons, empty
...
//		jLabel3.setText(Local.getString("Look and feel:")); //TODO look and feel errors
		gbc = new GridBagConstraints();
		gbc.gridx = 0;
		gbc.gridy = 4;
		gbc.insets = new Insets(2, 10, 0, 15);
...
//		GeneralPanel.add(lfClassName, gbc);
		...
		tabbedPanel.add(editorConfigPanel, Local.getString("Font Editor"));
